...
const english: Record<string, string> = {
  ...
  全部可见厂商: "All visible vendors",
  全部投递状态: "All delivery states",
  全部状态: "All states",
  全部阶段: "All phases",
  关注厂商: "Vendors to monitor",
  关注这些厂商: "Monitor these vendors",
  "关闭后保留配置，暂停匹配新的事件。":
  ...
  卡片: "Cards",
  厂商: "Vendor",
  "厂商事件更新会出现在这里。": "Vendor incident updates will appear here.",
  厂商尚未结束的事件: "Unresolved vendor incidents",
  厂商更新时间: "Vendor updated",
  厂商状态: "Vendor status",
  厂商状态工作台: "Vendor status console",
  厂商状态筛选: "Filter vendor status",
  厂商详情: "Vendor details",
  历史记录: "History",
  ...
  当前工作区可见的厂商: "Vendors visible to this workspace",
  "当前没有活跃事件，部分采集数据需要检查":
  ...
  "选择厂商，留空表示全部": "Select vendors; leave blank for all",
