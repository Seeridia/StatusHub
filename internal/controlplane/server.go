...
type Repository interface {
	...
	ListSources(context.Context, string, *store.TimeCursor, int) ([]store.SourceView, error)
	...
	SetSourceEnabled(context.Context, string, string, bool, store.AuditActor) (store.SourceView, error)
	ListIncidents(context.Context, string, string, string, *time.Time, *store.TimeCursor, int) ([]store.IncidentView, error)
	Incident(context.Context, string, string) (store.IncidentView, error)
	ListSubscriptions(context.Context, string, *store.TimeCursor, int) ([]store.SubscriptionView, error)
	...
	ListEndpoints(context.Context, string, *store.TimeCursor, int) ([]store.EndpointView, error)
